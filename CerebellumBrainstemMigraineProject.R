...
Dataset = fread(file = "Set yout own path")
...
sum(ViralBacterialNSInfections)

ViralBacterialNSInfections = as.factor(ViralBacterialNSInfections)
...
NSDiseases = as.factor(NSDiseases)
...
sum(MentalBehaviouralDisordersPsychoactiveSubstances)

MentalBehaviouralDisordersPsychoactiveSubstances = as.factor(MentalBehaviouralDisordersPsychoactiveSubstances)

# Psychiatric, mental, behavioural disorders

PsychiatricMentalBehaviouralDisorders  = rep(0, length(Sex))

for (i in 294:552) {
  PsychiatricMentalBehaviouralDisorders[Dataset[, ..i] == 	"F00"	] = 1
  PsychiatricMentalBehaviouralDisorders[Dataset[, ..i] == 	"F000"	] = 1
  PsychiatricMentalBehaviouralDisorders[Dataset[, ..i] == 	"F001"	] = 1
  PsychiatricMentalBehaviouralDisorders[Dataset[, ..i] == 	"F002"	] = 1
  PsychiatricMentalBehaviouralDisorders[Dataset[, ..i] == 	"F009"	] = 1
  PsychiatricMentalBehaviouralDisorders[Dataset[, ..i] == 	"F01"	] = 1
  PsychiatricMentalBehaviouralDisorders[Dataset[, ..i] == 	"F010"	] = 1
  PsychiatricMentalBehaviouralDisorders[Dataset[, ..i] == 	"F011"	] = 1
  PsychiatricMentalBehaviouralDisorders[Dataset[, ..i] == 	"F012"	] = 1
  PsychiatricMentalBehaviouralDisorders[Dataset[, ..i] == 	"F013"	] = 1
  PsychiatricMentalBehaviouralDisorders[Dataset[, ..i] == 	"F018"	] = 1
  PsychiatricMentalBehaviouralDisorders[Dataset[, ..i] == 	"F019"	] = 1
  PsychiatricMentalBehaviouralDisorders[Dataset[, ..i] == 	"F02"	] = 1
  PsychiatricMentalBehaviouralDisorders[Dataset[, ..i] == 	"F020"	] = 1
  PsychiatricMentalBehaviouralDisorders[Dataset[, ..i] == 	"F021"	] = 1
  PsychiatricMentalBehaviouralDisorders[Dataset[, ..i] == 	"F022"	] = 1
  PsychiatricMentalBehaviouralDisorders[Dataset[, ..i] == 	"F023"	] = 1
  PsychiatricMentalBehaviouralDisorders[Dataset[, ..i] == 	"F024"	] = 1
  PsychiatricMentalBehaviouralDisorders[Dataset[, ..i] == 	"F028"	] = 1
  PsychiatricMentalBehaviouralDisorders[Dataset[, ..i] == 	"F03"	] = 1
  PsychiatricMentalBehaviouralDisorders[Dataset[, ..i] == 	"F04"	] = 1
  PsychiatricMentalBehaviouralDisorders[Dataset[, ..i] == 	"F05"	] = 1
  PsychiatricMentalBehaviouralDisorders[Dataset[, ..i] == 	"F050"	] = 1
  PsychiatricMentalBehaviouralDisorders[Dataset[, ..i] == 	"F051"	] = 1
  PsychiatricMentalBehaviouralDisorders[Dataset[, ..i] == 	"F058"	] = 1
  PsychiatricMentalBehaviouralDisorders[Dataset[, ..i] == 	"F059"	] = 1
  PsychiatricMentalBehaviouralDisorders[Dataset[, ..i] == 	"F06"	] = 1
  PsychiatricMentalBehaviouralDisorders[Dataset[, ..i] == 	"F060"	] = 1
  PsychiatricMentalBehaviouralDisorders[Dataset[, ..i] == 	"F061"	] = 1
  PsychiatricMentalBehaviouralDisorders[Dataset[, ..i] == 	"F062"	] = 1
  PsychiatricMentalBehaviouralDisorders[Dataset[, ..i] == 	"F063"	] = 1
  PsychiatricMentalBehaviouralDisorders[Dataset[, ..i] == 	"F064"	] = 1
  PsychiatricMentalBehaviouralDisorders[Dataset[, ..i] == 	"F065"	] = 1
  PsychiatricMentalBehaviouralDisorders[Dataset[, ..i] == 	"F066"	] = 1
  PsychiatricMentalBehaviouralDisorders[Dataset[, ..i] == 	"F067"	] = 1
  PsychiatricMentalBehaviouralDisorders[Dataset[, ..i] == 	"F068"	] = 1
  PsychiatricMentalBehaviouralDisorders[Dataset[, ..i] == 	"F069"	] = 1
  PsychiatricMentalBehaviouralDisorders[Dataset[, ..i] == 	"F07"	] = 1
  PsychiatricMentalBehaviouralDisorders[Dataset[, ..i] == 	"F070"	] = 1
  PsychiatricMentalBehaviouralDisorders[Dataset[, ..i] == 	"F071"	] = 1
  PsychiatricMentalBehaviouralDisorders[Dataset[, ..i] == 	"F072"	] = 1
  PsychiatricMentalBehaviouralDisorders[Dataset[, ..i] == 	"F078"	] = 1
  PsychiatricMentalBehaviouralDisorders[Dataset[, ..i] == 	"F079"	] = 1
  PsychiatricMentalBehaviouralDisorders[Dataset[, ..i] == 	"F09"	] = 1
  PsychiatricMentalBehaviouralDisorders[Dataset[, ..i] == 	"F20"	] = 1
  PsychiatricMentalBehaviouralDisorders[Dataset[, ..i] == 	"F200"	] = 1
  PsychiatricMentalBehaviouralDisorders[Dataset[, ..i] == 	"F201"	] = 1
  PsychiatricMentalBehaviouralDisorders[Dataset[, ..i] == 	"F202"	] = 1
  PsychiatricMentalBehaviouralDisorders[Dataset[, ..i] == 	"F203"	] = 1
  PsychiatricMentalBehaviouralDisorders[Dataset[, ..i] == 	"F204"	] = 1
  PsychiatricMentalBehaviouralDisorders[Dataset[, ..i] == 	"F205"	] = 1
  PsychiatricMentalBehaviouralDisorders[Dataset[, ..i] == 	"F206"	] = 1
  PsychiatricMentalBehaviouralDisorders[Dataset[, ..i] == 	"F208"	] = 1
  PsychiatricMentalBehaviouralDisorders[Dataset[, ..i] == 	"F209"	] = 1
  PsychiatricMentalBehaviouralDisorders[Dataset[, ..i] == 	"F21"	] = 1
  PsychiatricMentalBehaviouralDisorders[Dataset[, ..i] == 	"F22"	] = 1
  PsychiatricMentalBehaviouralDisorders[Dataset[, ..i] == 	"F220"	] = 1
  PsychiatricMentalBehaviouralDisorders[Dataset[, ..i] == 	"F228"	] = 1
  PsychiatricMentalBehaviouralDisorders[Dataset[, ..i] == 	"F229"	] = 1
  PsychiatricMentalBehaviouralDisorders[Dataset[, ..i] == 	"F23"	] = 1
  PsychiatricMentalBehaviouralDisorders[Dataset[, ..i] == 	"F230"	] = 1
  PsychiatricMentalBehaviouralDisorders[Dataset[, ..i] == 	"F231"	] = 1
  PsychiatricMentalBehaviouralDisorders[Dataset[, ..i] == 	"F232"	] = 1
  PsychiatricMentalBehaviouralDisorders[Dataset[, ..i] == 	"F233"	] = 1
  PsychiatricMentalBehaviouralDisorders[Dataset[, ..i] == 	"F238"	] = 1
  PsychiatricMentalBehaviouralDisorders[Dataset[, ..i] == 	"F239"	] = 1
  PsychiatricMentalBehaviouralDisorders[Dataset[, ..i] == 	"F24"	] = 1
  PsychiatricMentalBehaviouralDisorders[Dataset[, ..i] == 	"F25"	] = 1
  PsychiatricMentalBehaviouralDisorders[Dataset[, ..i] == 	"F250"	] = 1
  PsychiatricMentalBehaviouralDisorders[Dataset[, ..i] == 	"F251"	] = 1
  PsychiatricMentalBehaviouralDisorders[Dataset[, ..i] == 	"F252"	] = 1
  PsychiatricMentalBehaviouralDisorders[Dataset[, ..i] == 	"F258"	] = 1
  PsychiatricMentalBehaviouralDisorders[Dataset[, ..i] == 	"F259"	] = 1
  PsychiatricMentalBehaviouralDisorders[Dataset[, ..i] == 	"F28"	] = 1
  PsychiatricMentalBehaviouralDisorders[Dataset[, ..i] == 	"F29"	] = 1
  PsychiatricMentalBehaviouralDisorders[Dataset[, ..i] == 	"F30"	] = 1
  PsychiatricMentalBehaviouralDisorders[Dataset[, ..i] == 	"F300"	] = 1
  PsychiatricMentalBehaviouralDisorders[Dataset[, ..i] == 	"F301"	] = 1
  PsychiatricMentalBehaviouralDisorders[Dataset[, ..i] == 	"F302"	] = 1
  PsychiatricMentalBehaviouralDisorders[Dataset[, ..i] == 	"F308"	] = 1
  PsychiatricMentalBehaviouralDisorders[Dataset[, ..i] == 	"F309"	] = 1
  PsychiatricMentalBehaviouralDisorders[Dataset[, ..i] == 	"F31"	] = 1
  PsychiatricMentalBehaviouralDisorders[Dataset[, ..i] == 	"F310"	] = 1
  PsychiatricMentalBehaviouralDisorders[Dataset[, ..i] == 	"F311"	] = 1
  PsychiatricMentalBehaviouralDisorders[Dataset[, ..i] == 	"F312"	] = 1
  PsychiatricMentalBehaviouralDisorders[Dataset[, ..i] == 	"F313"	] = 1
  PsychiatricMentalBehaviouralDisorders[Dataset[, ..i] == 	"F314"	] = 1
  PsychiatricMentalBehaviouralDisorders[Dataset[, ..i] == 	"F315"	] = 1
  PsychiatricMentalBehaviouralDisorders[Dataset[, ..i] == 	"F316"	] = 1
  PsychiatricMentalBehaviouralDisorders[Dataset[, ..i] == 	"F317"	] = 1
  PsychiatricMentalBehaviouralDisorders[Dataset[, ..i] == 	"F318"	] = 1
  PsychiatricMentalBehaviouralDisorders[Dataset[, ..i] == 	"F319"	] = 1
  PsychiatricMentalBehaviouralDisorders[Dataset[, ..i] == 	"F34"	] = 1
  PsychiatricMentalBehaviouralDisorders[Dataset[, ..i] == 	"F340"	] = 1
  PsychiatricMentalBehaviouralDisorders[Dataset[, ..i] == 	"F341"	] = 1
  PsychiatricMentalBehaviouralDisorders[Dataset[, ..i] == 	"F348"	] = 1
  PsychiatricMentalBehaviouralDisorders[Dataset[, ..i] == 	"F349"	] = 1
  PsychiatricMentalBehaviouralDisorders[Dataset[, ..i] == 	"F38"	] = 1
  PsychiatricMentalBehaviouralDisorders[Dataset[, ..i] == 	"F380"	] = 1
  PsychiatricMentalBehaviouralDisorders[Dataset[, ..i] == 	"F381"	] = 1
  PsychiatricMentalBehaviouralDisorders[Dataset[, ..i] == 	"F388"	] = 1
  PsychiatricMentalBehaviouralDisorders[Dataset[, ..i] == 	"F39"	] = 1
  PsychiatricMentalBehaviouralDisorders[Dataset[, ..i] == 	"F40"	] = 1
  PsychiatricMentalBehaviouralDisorders[Dataset[, ..i] == 	"F400"	] = 1
  PsychiatricMentalBehaviouralDisorders[Dataset[, ..i] == 	"F401"	] = 1
  PsychiatricMentalBehaviouralDisorders[Dataset[, ..i] == 	"F402"	] = 1
  PsychiatricMentalBehaviouralDisorders[Dataset[, ..i] == 	"F408"	] = 1
  PsychiatricMentalBehaviouralDisorders[Dataset[, ..i] == 	"F409"	] = 1
  PsychiatricMentalBehaviouralDisorders[Dataset[, ..i] == 	"F41"	] = 1
  PsychiatricMentalBehaviouralDisorders[Dataset[, ..i] == 	"F410"	] = 1
  PsychiatricMentalBehaviouralDisorders[Dataset[, ..i] == 	"F411"	] = 1
  PsychiatricMentalBehaviouralDisorders[Dataset[, ..i] == 	"F412"	] = 1
  PsychiatricMentalBehaviouralDisorders[Dataset[, ..i] == 	"F413"	] = 1
  PsychiatricMentalBehaviouralDisorders[Dataset[, ..i] == 	"F418"	] = 1
  PsychiatricMentalBehaviouralDisorders[Dataset[, ..i] == 	"F419"	] = 1
  PsychiatricMentalBehaviouralDisorders[Dataset[, ..i] == 	"F42"	] = 1
  PsychiatricMentalBehaviouralDisorders[Dataset[, ..i] == 	"F420"	] = 1
  PsychiatricMentalBehaviouralDisorders[Dataset[, ..i] == 	"F421"	] = 1
  PsychiatricMentalBehaviouralDisorders[Dataset[, ..i] == 	"F422"	] = 1
  PsychiatricMentalBehaviouralDisorders[Dataset[, ..i] == 	"F428"	] = 1
  PsychiatricMentalBehaviouralDisorders[Dataset[, ..i] == 	"F429"	] = 1
  PsychiatricMentalBehaviouralDisorders[Dataset[, ..i] == 	"F43"	] = 1
  PsychiatricMentalBehaviouralDisorders[Dataset[, ..i] == 	"F430"	] = 1
  PsychiatricMentalBehaviouralDisorders[Dataset[, ..i] == 	"F431"	] = 1
  PsychiatricMentalBehaviouralDisorders[Dataset[, ..i] == 	"F432"	] = 1
  PsychiatricMentalBehaviouralDisorders[Dataset[, ..i] == 	"F438"	] = 1
  PsychiatricMentalBehaviouralDisorders[Dataset[, ..i] == 	"F439"	] = 1
  PsychiatricMentalBehaviouralDisorders[Dataset[, ..i] == 	"F44"	] = 1
  PsychiatricMentalBehaviouralDisorders[Dataset[, ..i] == 	"F440"	] = 1
  PsychiatricMentalBehaviouralDisorders[Dataset[, ..i] == 	"F441"	] = 1
  PsychiatricMentalBehaviouralDisorders[Dataset[, ..i] == 	"F442"	] = 1
  PsychiatricMentalBehaviouralDisorders[Dataset[, ..i] == 	"F443"	] = 1
  PsychiatricMentalBehaviouralDisorders[Dataset[, ..i] == 	"F444"	] = 1
  PsychiatricMentalBehaviouralDisorders[Dataset[, ..i] == 	"F445"	] = 1
  PsychiatricMentalBehaviouralDisorders[Dataset[, ..i] == 	"F446"	] = 1
  PsychiatricMentalBehaviouralDisorders[Dataset[, ..i] == 	"F447"	] = 1
  PsychiatricMentalBehaviouralDisorders[Dataset[, ..i] == 	"F448"	] = 1
  PsychiatricMentalBehaviouralDisorders[Dataset[, ..i] == 	"F449"	] = 1
  PsychiatricMentalBehaviouralDisorders[Dataset[, ..i] == 	"F45"	] = 1
  PsychiatricMentalBehaviouralDisorders[Dataset[, ..i] == 	"F450"	] = 1
  PsychiatricMentalBehaviouralDisorders[Dataset[, ..i] == 	"F451"	] = 1
  PsychiatricMentalBehaviouralDisorders[Dataset[, ..i] == 	"F452"	] = 1
  PsychiatricMentalBehaviouralDisorders[Dataset[, ..i] == 	"F453"	] = 1
  PsychiatricMentalBehaviouralDisorders[Dataset[, ..i] == 	"F454"	] = 1
  PsychiatricMentalBehaviouralDisorders[Dataset[, ..i] == 	"F458"	] = 1
  PsychiatricMentalBehaviouralDisorders[Dataset[, ..i] == 	"F459"	] = 1
  PsychiatricMentalBehaviouralDisorders[Dataset[, ..i] == 	"F48"	] = 1
  PsychiatricMentalBehaviouralDisorders[Dataset[, ..i] == 	"F480"	] = 1
  PsychiatricMentalBehaviouralDisorders[Dataset[, ..i] == 	"F481"	] = 1
  PsychiatricMentalBehaviouralDisorders[Dataset[, ..i] == 	"F488"	] = 1
  PsychiatricMentalBehaviouralDisorders[Dataset[, ..i] == 	"F489"	] = 1
  PsychiatricMentalBehaviouralDisorders[Dataset[, ..i] == 	"F50"	] = 1
  PsychiatricMentalBehaviouralDisorders[Dataset[, ..i] == 	"F500"	] = 1
  PsychiatricMentalBehaviouralDisorders[Dataset[, ..i] == 	"F501"	] = 1
  PsychiatricMentalBehaviouralDisorders[Dataset[, ..i] == 	"F502"	] = 1
  PsychiatricMentalBehaviouralDisorders[Dataset[, ..i] == 	"F503"	] = 1
  PsychiatricMentalBehaviouralDisorders[Dataset[, ..i] == 	"F504"	] = 1
  PsychiatricMentalBehaviouralDisorders[Dataset[, ..i] == 	"F505"	] = 1
  PsychiatricMentalBehaviouralDisorders[Dataset[, ..i] == 	"F508"	] = 1
  PsychiatricMentalBehaviouralDisorders[Dataset[, ..i] == 	"F509"	] = 1
  PsychiatricMentalBehaviouralDisorders[Dataset[, ..i] == 	"F53"	] = 1
  PsychiatricMentalBehaviouralDisorders[Dataset[, ..i] == 	"F530"	] = 1
  PsychiatricMentalBehaviouralDisorders[Dataset[, ..i] == 	"F531"	] = 1
  PsychiatricMentalBehaviouralDisorders[Dataset[, ..i] == 	"F538"	] = 1
  PsychiatricMentalBehaviouralDisorders[Dataset[, ..i] == 	"F539"	] = 1
  PsychiatricMentalBehaviouralDisorders[Dataset[, ..i] == 	"F54"	] = 1
  PsychiatricMentalBehaviouralDisorders[Dataset[, ..i] == 	"F55"	] = 1
  PsychiatricMentalBehaviouralDisorders[Dataset[, ..i] == 	"F59"	] = 1
  PsychiatricMentalBehaviouralDisorders[Dataset[, ..i] == 	"F62"	] = 1
  PsychiatricMentalBehaviouralDisorders[Dataset[, ..i] == 	"F620"	] = 1
  PsychiatricMentalBehaviouralDisorders[Dataset[, ..i] == 	"F621"	] = 1
  PsychiatricMentalBehaviouralDisorders[Dataset[, ..i] == 	"F628"	] = 1
  PsychiatricMentalBehaviouralDisorders[Dataset[, ..i] == 	"F629"	] = 1
  PsychiatricMentalBehaviouralDisorders[Dataset[, ..i] == 	"F63"	] = 1
  PsychiatricMentalBehaviouralDisorders[Dataset[, ..i] == 	"F630"	] = 1
  PsychiatricMentalBehaviouralDisorders[Dataset[, ..i] == 	"F631"	] = 1
  PsychiatricMentalBehaviouralDisorders[Dataset[, ..i] == 	"F632"	] = 1
  PsychiatricMentalBehaviouralDisorders[Dataset[, ..i] == 	"F633"	] = 1
  PsychiatricMentalBehaviouralDisorders[Dataset[, ..i] == 	"F638"	] = 1
  PsychiatricMentalBehaviouralDisorders[Dataset[, ..i] == 	"F639"	] = 1
  PsychiatricMentalBehaviouralDisorders[Dataset[, ..i] == 	"F68"	] = 1
  PsychiatricMentalBehaviouralDisorders[Dataset[, ..i] == 	"F680"	] = 1
  PsychiatricMentalBehaviouralDisorders[Dataset[, ..i] == 	"F681"	] = 1
  PsychiatricMentalBehaviouralDisorders[Dataset[, ..i] == 	"F688"	] = 1
  PsychiatricMentalBehaviouralDisorders[Dataset[, ..i] == 	"F69"	] = 1
  PsychiatricMentalBehaviouralDisorders[Dataset[, ..i] == 	"F99"	] = 1
  PsychiatricMentalBehaviouralDisorders[Dataset[, ..i] == 	"F32"	] = 1
  PsychiatricMentalBehaviouralDisorders[Dataset[, ..i] == 	"F320"	] = 1
  PsychiatricMentalBehaviouralDisorders[Dataset[, ..i] == 	"F321"	] = 1
  PsychiatricMentalBehaviouralDisorders[Dataset[, ..i] == 	"F322"	] = 1
  PsychiatricMentalBehaviouralDisorders[Dataset[, ..i] == 	"F323"	] = 1
  PsychiatricMentalBehaviouralDisorders[Dataset[, ..i] == 	"F328"	] = 1
  PsychiatricMentalBehaviouralDisorders[Dataset[, ..i] == 	"F329"	] = 1
  PsychiatricMentalBehaviouralDisorders[Dataset[, ..i] == 	"F33"	] = 1
  PsychiatricMentalBehaviouralDisorders[Dataset[, ..i] == 	"F330"	] = 1
  PsychiatricMentalBehaviouralDisorders[Dataset[, ..i] == 	"F331"	] = 1
  PsychiatricMentalBehaviouralDisorders[Dataset[, ..i] == 	"F332"	] = 1
  PsychiatricMentalBehaviouralDisorders[Dataset[, ..i] == 	"F333"	] = 1
  PsychiatricMentalBehaviouralDisorders[Dataset[, ..i] == 	"F334"	] = 1
  PsychiatricMentalBehaviouralDisorders[Dataset[, ..i] == 	"F338"	] = 1
  PsychiatricMentalBehaviouralDisorders[Dataset[, ..i] == 	"F339"	] = 1
  
}

sum(PsychiatricMentalBehaviouralDisorders)

PsychiatricMentalBehaviouralDisorders = as.factor(PsychiatricMentalBehaviouralDisorders)
...
DevelopmentalDisorders = as.factor(DevelopmentalDisorders)
...
sum(EpilepsySleepDisorders)

EpilepsySleepDisorders = as.factor(EpilepsySleepDisorders)
...
MuscleDisorders = as.factor(MuscleDisorders)
...
OtherHeadaches = as.factor(OtherHeadaches)
...
Neuropathies = as.factor(Neuropathies)
...
sum(BrainSpineMalformationsAbnormalities)

BrainSpineMalformationsAbnormalities = as.factor(BrainSpineMalformationsAbnormalities)
...
sum(CerebrovascularDiseases)

CerebrovascularDiseases = as.factor(CerebrovascularDiseases)
...
sum(HeadSpineInjuriesFractures)

HeadSpineInjuriesFractures = as.factor(HeadSpineInjuriesFractures)

# Cardiovascular Diseases

CardiovascularDiseases  = rep(0, length(Sex))

for (i in 294:552) {
  
  CardiovascularDiseases[Dataset[, ..i] == 	"I00"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I01"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I010"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I011"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I012"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I018"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I019"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I02"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I020"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I029"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I05"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I050"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I051"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I052"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I058"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I059"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I06"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I060"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I061"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I062"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I068"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I069"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I07"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I070"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I071"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I072"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I078"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I079"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I08"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I080"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I081"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I082"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I083"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I088"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I089"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I09"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I090"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I091"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I092"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I098"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I099"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I10"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I11"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I110"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I119"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I12"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I120"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I129"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I13"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I130"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I131"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I132"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I139"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I15"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I150"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I151"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I152"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I158"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I159"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I20"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I200"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I201"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I208"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I209"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I21"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I210"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I211"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I212"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I213"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I214"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I219"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I21X"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I22"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I220"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I221"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I228"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I229"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I23"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I230"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I231"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I232"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I233"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I234"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I235"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I236"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I238"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I24"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I240"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I241"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I248"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I249"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I25"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I250"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I251"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I252"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I253"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I254"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I255"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I256"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I258"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I259"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I26"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I260"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I269"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I27"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I270"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I271"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I272"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I278"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I279"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I28"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I280"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I281"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I288"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I289"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I30"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I300"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I301"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I308"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I309"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I31"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I310"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I311"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I312"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I313"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I318"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I319"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I32"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I320"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I321"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I328"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I33"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I330"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I339"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I34"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I340"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I341"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I342"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I348"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I349"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I35"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I350"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I351"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I352"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I358"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I359"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I36"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I360"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I361"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I362"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I368"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I369"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I37"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I370"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I371"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I372"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I378"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I379"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I38"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I39"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I390"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I391"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I392"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I393"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I394"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I398"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I40"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I400"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I401"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I408"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I409"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I41"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I410"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I411"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I412"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I418"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I42"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I420"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I421"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I422"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I423"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I424"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I425"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I426"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I427"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I428"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I429"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I43"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I430"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I431"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I432"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I438"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I44"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I440"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I441"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I442"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I443"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I444"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I445"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I446"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I447"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I45"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I450"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I451"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I452"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I453"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I454"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I455"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I456"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I458"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I459"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I46"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I460"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I461"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I469"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I47"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I470"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I471"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I472"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I479"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I48"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I480"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I481"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I482"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I483"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I484"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I489"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I49"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I490"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I491"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I492"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I493"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I494"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I495"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I498"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I499"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I50"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I500"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I501"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I509"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I51"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I510"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I511"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I512"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I513"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I514"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I515"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I516"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I517"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I518"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I519"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I52"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I520"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I521"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I528"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I70"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I700"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I7000"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I7001"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I701"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I7010"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I7011"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I702"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I7020"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I7021"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I708"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I7080"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I7081"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I709"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I7090"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I7091"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I71"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I710"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I711"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I712"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I713"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I714"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I715"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I716"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I718"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I719"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I72"	] = 1
  CardiovascularDiseases[Dataset[, ..i] == 	"I720"	] = 1
CardiovascularDiseases[Dataset[, ..i] == 	"I721"	] = 1
CardiovascularDiseases[Dataset[, ..i] == 	"I722"	] = 1
CardiovascularDiseases[Dataset[, ..i] == 	"I723"	] = 1
CardiovascularDiseases[Dataset[, ..i] == 	"I724"	] = 1
CardiovascularDiseases[Dataset[, ..i] == 	"I725"	] = 1
CardiovascularDiseases[Dataset[, ..i] == 	"I726"	] = 1
CardiovascularDiseases[Dataset[, ..i] == 	"I728"	] = 1
CardiovascularDiseases[Dataset[, ..i] == 	"I729"	] = 1
CardiovascularDiseases[Dataset[, ..i] == 	"I73"	] = 1
CardiovascularDiseases[Dataset[, ..i] == 	"I730"	] = 1
CardiovascularDiseases[Dataset[, ..i] == 	"I731"	] = 1
CardiovascularDiseases[Dataset[, ..i] == 	"I738"	] = 1
CardiovascularDiseases[Dataset[, ..i] == 	"I739"	] = 1
CardiovascularDiseases[Dataset[, ..i] == 	"I74"	] = 1
CardiovascularDiseases[Dataset[, ..i] == 	"I740"	] = 1
CardiovascularDiseases[Dataset[, ..i] == 	"I741"	] = 1
CardiovascularDiseases[Dataset[, ..i] == 	"I742"	] = 1
CardiovascularDiseases[Dataset[, ..i] == 	"I743"	] = 1
CardiovascularDiseases[Dataset[, ..i] == 	"I744"	] = 1
CardiovascularDiseases[Dataset[, ..i] == 	"I745"	] = 1
CardiovascularDiseases[Dataset[, ..i] == 	"I748"	] = 1
CardiovascularDiseases[Dataset[, ..i] == 	"I749"	] = 1
CardiovascularDiseases[Dataset[, ..i] == 	"I77"	] = 1
CardiovascularDiseases[Dataset[, ..i] == 	"I770"	] = 1
CardiovascularDiseases[Dataset[, ..i] == 	"I771"	] = 1
CardiovascularDiseases[Dataset[, ..i] == 	"I772"	] = 1
CardiovascularDiseases[Dataset[, ..i] == 	"I773"	] = 1
CardiovascularDiseases[Dataset[, ..i] == 	"I774"	] = 1
CardiovascularDiseases[Dataset[, ..i] == 	"I775"	] = 1
CardiovascularDiseases[Dataset[, ..i] == 	"I776"	] = 1
CardiovascularDiseases[Dataset[, ..i] == 	"I778"	] = 1
CardiovascularDiseases[Dataset[, ..i] == 	"I779"	] = 1
CardiovascularDiseases[Dataset[, ..i] == 	"I78"	] = 1
CardiovascularDiseases[Dataset[, ..i] == 	"I780"	] = 1
CardiovascularDiseases[Dataset[, ..i] == 	"I781"	] = 1
CardiovascularDiseases[Dataset[, ..i] == 	"I788"	] = 1
CardiovascularDiseases[Dataset[, ..i] == 	"I789"	] = 1
CardiovascularDiseases[Dataset[, ..i] == 	"I79"	] = 1
CardiovascularDiseases[Dataset[, ..i] == 	"I790"	] = 1
CardiovascularDiseases[Dataset[, ..i] == 	"I791"	] = 1
CardiovascularDiseases[Dataset[, ..i] == 	"I792"	] = 1
CardiovascularDiseases[Dataset[, ..i] == 	"I798"	] = 1
CardiovascularDiseases[Dataset[, ..i] == 	"I80"	] = 1
CardiovascularDiseases[Dataset[, ..i] == 	"I800"	] = 1
CardiovascularDiseases[Dataset[, ..i] == 	"I801"	] = 1
CardiovascularDiseases[Dataset[, ..i] == 	"I802"	] = 1
CardiovascularDiseases[Dataset[, ..i] == 	"I803"	] = 1
CardiovascularDiseases[Dataset[, ..i] == 	"I808"	] = 1
CardiovascularDiseases[Dataset[, ..i] == 	"I809"	] = 1
CardiovascularDiseases[Dataset[, ..i] == 	"I81"	] = 1
CardiovascularDiseases[Dataset[, ..i] == 	"I82"	] = 1
CardiovascularDiseases[Dataset[, ..i] == 	"I820"	] = 1
CardiovascularDiseases[Dataset[, ..i] == 	"I821"	] = 1
CardiovascularDiseases[Dataset[, ..i] == 	"I822"	] = 1
CardiovascularDiseases[Dataset[, ..i] == 	"I823"	] = 1
CardiovascularDiseases[Dataset[, ..i] == 	"I828"	] = 1
CardiovascularDiseases[Dataset[, ..i] == 	"I829"	] = 1
CardiovascularDiseases[Dataset[, ..i] == 	"I83"	] = 1
CardiovascularDiseases[Dataset[, ..i] == 	"I830"	] = 1
CardiovascularDiseases[Dataset[, ..i] == 	"I831"	] = 1
CardiovascularDiseases[Dataset[, ..i] == 	"I832"	] = 1
CardiovascularDiseases[Dataset[, ..i] == 	"I839"	] = 1
CardiovascularDiseases[Dataset[, ..i] == 	"I84"	] = 1
CardiovascularDiseases[Dataset[, ..i] == 	"I840"	] = 1
CardiovascularDiseases[Dataset[, ..i] == 	"I841"	] = 1
CardiovascularDiseases[Dataset[, ..i] == 	"I842"	] = 1
CardiovascularDiseases[Dataset[, ..i] == 	"I843"	] = 1
CardiovascularDiseases[Dataset[, ..i] == 	"I844"	] = 1
CardiovascularDiseases[Dataset[, ..i] == 	"I845"	] = 1
CardiovascularDiseases[Dataset[, ..i] == 	"I846"	] = 1
CardiovascularDiseases[Dataset[, ..i] == 	"I847"	] = 1
CardiovascularDiseases[Dataset[, ..i] == 	"I848"	] = 1
CardiovascularDiseases[Dataset[, ..i] == 	"I849"	] = 1
CardiovascularDiseases[Dataset[, ..i] == 	"I85"	] = 1
CardiovascularDiseases[Dataset[, ..i] == 	"I850"	] = 1
CardiovascularDiseases[Dataset[, ..i] == 	"I859"	] = 1
CardiovascularDiseases[Dataset[, ..i] == 	"I86"	] = 1
CardiovascularDiseases[Dataset[, ..i] == 	"I860"	] = 1
CardiovascularDiseases[Dataset[, ..i] == 	"I861"	] = 1
CardiovascularDiseases[Dataset[, ..i] == 	"I862"	] = 1
CardiovascularDiseases[Dataset[, ..i] == 	"I863"	] = 1
CardiovascularDiseases[Dataset[, ..i] == 	"I864"	] = 1
CardiovascularDiseases[Dataset[, ..i] == 	"I868"	] = 1
CardiovascularDiseases[Dataset[, ..i] == 	"I87"	] = 1
CardiovascularDiseases[Dataset[, ..i] == 	"I870"	] = 1
CardiovascularDiseases[Dataset[, ..i] == 	"I871"	] = 1
CardiovascularDiseases[Dataset[, ..i] == 	"I872"	] = 1
CardiovascularDiseases[Dataset[, ..i] == 	"I878"	] = 1
CardiovascularDiseases[Dataset[, ..i] == 	"I879"	] = 1
CardiovascularDiseases[Dataset[, ..i] == 	"I88"	] = 1
CardiovascularDiseases[Dataset[, ..i] == 	"I880"	] = 1
CardiovascularDiseases[Dataset[, ..i] == 	"I881"	] = 1
CardiovascularDiseases[Dataset[, ..i] == 	"I888"	] = 1
CardiovascularDiseases[Dataset[, ..i] == 	"I889"	] = 1
CardiovascularDiseases[Dataset[, ..i] == 	"I89"	] = 1
CardiovascularDiseases[Dataset[, ..i] == 	"I890"	] = 1
CardiovascularDiseases[Dataset[, ..i] == 	"I891"	] = 1
CardiovascularDiseases[Dataset[, ..i] == 	"I898"	] = 1
CardiovascularDiseases[Dataset[, ..i] == 	"I899"	] = 1
CardiovascularDiseases[Dataset[, ..i] == 	"I95"	] = 1
CardiovascularDiseases[Dataset[, ..i] == 	"I950"	] = 1
CardiovascularDiseases[Dataset[, ..i] == 	"I951"	] = 1
CardiovascularDiseases[Dataset[, ..i] == 	"I952"	] = 1
CardiovascularDiseases[Dataset[, ..i] == 	"I958"	] = 1
CardiovascularDiseases[Dataset[, ..i] == 	"I959"	] = 1
CardiovascularDiseases[Dataset[, ..i] == 	"I97"	] = 1
CardiovascularDiseases[Dataset[, ..i] == 	"I970"	] = 1
CardiovascularDiseases[Dataset[, ..i] == 	"I971"	] = 1
CardiovascularDiseases[Dataset[, ..i] == 	"I972"	] = 1
CardiovascularDiseases[Dataset[, ..i] == 	"I978"	] = 1
CardiovascularDiseases[Dataset[, ..i] == 	"I979"	] = 1
CardiovascularDiseases[Dataset[, ..i] == 	"I98"	] = 1
CardiovascularDiseases[Dataset[, ..i] == 	"I980"	] = 1
CardiovascularDiseases[Dataset[, ..i] == 	"I981"	] = 1
CardiovascularDiseases[Dataset[, ..i] == 	"I982"	] = 1
CardiovascularDiseases[Dataset[, ..i] == 	"I983"	] = 1
CardiovascularDiseases[Dataset[, ..i] == 	"I988"	] = 1
CardiovascularDiseases[Dataset[, ..i] == 	"I99"	] = 1

  
}

sum(CardiovascularDiseases)

CardiovascularDiseases = as.factor(CardiovascularDiseases)
...
BrainCancer = as.factor(BrainCancer)
...
CrusII = Dataset$`25903-2.0` + Dataset$`25904-2.0` + Dataset$`25905-2.0`

# Regions I-IV

RegionI_IV = Dataset$`25893-2.0` + Dataset$`25894-2.0`

# Region V

RegionV = Dataset$`25895-2.0` + Dataset$`25896-2.0`

# Region VI

RegionVI = Dataset$`25897-2.0` + Dataset$`25898-2.0` + Dataset$`25899-2.0`

# Region VIIb

RegionVIIb = Dataset$`25906-2.0` + Dataset$`25907-2.0` + Dataset$`25908-2.0`

# Region VIIIa

RegionVIIIa = Dataset$`25909-2.0` + Dataset$`25910-2.0` + Dataset$`25911-2.0`

# Region VIIIb

RegionVIIIb = Dataset$`25912-2.0` + Dataset$`25913-2.0` + Dataset$`25914-2.0`

# Region IX

RegionIX = Dataset$`25915-2.0` + Dataset$`25916-2.0` + Dataset$`25917-2.0`

# Region X

RegionX = Dataset$`25918-2.0` + Dataset$`25919-2.0` + Dataset$`25920-2.0`

# Overall

Cerebellum = CrusI + CrusII + RegionI_IV + RegionV + RegionVI + RegionVIIb + RegionVIIIa + RegionVIIIb + RegionIX + RegionX
...
tapply(Sex, Migraine, table)

# Age - mean and standard deviations

tapply(Age, Migraine, mean)
tapply(Age, Migraine, sd)

hist(Age)

# BMI - mean and standard deviations

tapply(BMI, Migraine, Mean_NA)
tapply(BMI, Migraine, SD_NA)

hist(BMI)

# IMD - mean and standard deviations

tapply(IMD, Migraine, Mean_NA)
tapply(IMD, Migraine, SD_NA)
tapply(IMD, Migraine, summary)

hist(IMD)

# Smoking

tapply(Smoking, Migraine, table)

# Alcohol 

tapply(Alcohol, Migraine, table)

# Descriptives of the brain regions

tapply(Cerebellum, Migraine, summary)
tapply(Cerebellum, Migraine, SD_NA)

tapply(RegionI_IV, Migraine, summary)
tapply(RegionI_IV, Migraine, SD_NA)

tapply(RegionV, Migraine, summary)
tapply(RegionV, Migraine, SD_NA)

tapply(RegionVI, Migraine, summary)
tapply(RegionVI, Migraine, SD_NA)

tapply(CrusI, Migraine, summary)
tapply(CrusI, Migraine, SD_NA)

tapply(CrusII, Migraine, summary)
tapply(CrusII, Migraine, SD_NA)

tapply(RegionVIIb, Migraine, summary)
tapply(RegionVIIb, Migraine, SD_NA)

tapply(RegionVIIIa, Migraine, summary)
tapply(RegionVIIIa, Migraine, SD_NA)

tapply(RegionVIIIb, Migraine, summary)
tapply(RegionVIIIb, Migraine, SD_NA)

tapply(RegionIX, Migraine, summary)
tapply(RegionIX, Migraine, SD_NA)

tapply(RegionX, Migraine, summary)
tapply(RegionX, Migraine, SD_NA)

tapply(Brainstem, Migraine, summary)
tapply(Brainstem, Migraine, SD_NA)

tapply(TotalVolume, Migraine, summary)
tapply(TotalVolume, Migraine, SD_NA)



######### Brainstem

# Generalized linear model - ICD10

Brainstem.glm = glm(Brainstem ~ Migraine + Sex + Age + BMI + AssessmentCentre + Alcohol 
                    + Smoking + DiastolicBP + IMD + EthnicBackground + TotalVolume + ViralBacterialNSInfections 
                    + Diabetes + NSDiseases + MentalBehaviouralDisordersPsychoactiveSubstances
                    + PsychiatricMentalBehaviouralDisorders + DevelopmentalDisorders 
                    + EpilepsySleepDisorders + MuscleDisorders + OtherHeadaches 
                    + Neuropathies + BrainSpineMalformationsAbnormalities 
                    + CerebrovascularDiseases + HeadSpineInjuriesFractures +
                      CardiovascularDiseases + BrainCancer, family = "gaussian", data = Dataset)

summary(Brainstem.glm)$coefficients

tvalue = 0.84
df = 34753

CohenD = (tvalue*(712+45681))/(sqrt(712*45681)*sqrt(df))

confint(Brainstem.glm)
...
Cerebellum.glm = glm(Cerebellum ~ Migraine + Sex + Age + BMI + AssessmentCentre + Alcohol 
                    + Smoking + DiastolicBP + IMD + EthnicBackground + TotalVolume + ViralBacterialNSInfections 
                    + Diabetes + NSDiseases + MentalBehaviouralDisordersPsychoactiveSubstances
                    + PsychiatricMentalBehaviouralDisorders + DevelopmentalDisorders 
                    + EpilepsySleepDisorders + MuscleDisorders + OtherHeadaches 
...
summary(Cerebellum.glm)$coefficients
...
confint(Cerebellum.glm)


# Crus I

CrusI.glm = glm(CrusI ~ Migraine + Sex + Age + BMI + AssessmentCentre + Alcohol 
                     + Smoking + DiastolicBP + IMD + EthnicBackground + TotalVolume + ViralBacterialNSInfections 
                     + Diabetes + NSDiseases + MentalBehaviouralDisordersPsychoactiveSubstances
                     + PsychiatricMentalBehaviouralDisorders + DevelopmentalDisorders 
                     + EpilepsySleepDisorders + MuscleDisorders + OtherHeadaches 
...
summary(CrusI.glm)$coefficients
...
confint(CrusI.glm, level = 0.995)

# Crus II

CrusII.glm = glm(CrusII ~ Migraine + Sex + Age + BMI + AssessmentCentre + Alcohol 
                     + Smoking + DiastolicBP + IMD + EthnicBackground + TotalVolume + ViralBacterialNSInfections 
                     + Diabetes + NSDiseases + MentalBehaviouralDisordersPsychoactiveSubstances
                     + PsychiatricMentalBehaviouralDisorders + DevelopmentalDisorders 
                     + EpilepsySleepDisorders + MuscleDisorders + OtherHeadaches 
...
summary(CrusII.glm)$coefficients
...
confint(CrusII.glm, level = 0.995)

# Regions I-IV

RegionI_IV.glm = glm(RegionI_IV ~ Migraine + Sex + Age + BMI + AssessmentCentre + Alcohol 
                     + Smoking + DiastolicBP + IMD + EthnicBackground + TotalVolume + ViralBacterialNSInfections 
                     + Diabetes + NSDiseases + MentalBehaviouralDisordersPsychoactiveSubstances
                     + PsychiatricMentalBehaviouralDisorders + DevelopmentalDisorders 
                     + EpilepsySleepDisorders + MuscleDisorders + OtherHeadaches 
...
summary(RegionI_IV.glm)$coefficients
...
confint(RegionI_IV.glm)


# Region V

RegionV.glm = glm(RegionV ~ Migraine + Sex + Age + BMI + AssessmentCentre + Alcohol 
                     + Smoking + DiastolicBP + IMD + EthnicBackground + TotalVolume + ViralBacterialNSInfections 
                     + Diabetes + NSDiseases + MentalBehaviouralDisordersPsychoactiveSubstances
                     + PsychiatricMentalBehaviouralDisorders + DevelopmentalDisorders 
                     + EpilepsySleepDisorders + MuscleDisorders + OtherHeadaches 
...
summary(RegionV.glm)$coefficients
...
RegionVI.glm = glm(RegionVI ~ Migraine + Sex + Age + BMI + AssessmentCentre + Alcohol 
                     + Smoking + DiastolicBP + IMD + EthnicBackground + TotalVolume + ViralBacterialNSInfections 
                     + Diabetes + NSDiseases + MentalBehaviouralDisordersPsychoactiveSubstances
                     + PsychiatricMentalBehaviouralDisorders + DevelopmentalDisorders 
                     + EpilepsySleepDisorders + MuscleDisorders + OtherHeadaches 
...
summary(RegionVI.glm)$coefficients
...
confint(RegionVI.glm)

# Region VIIb

RegionVIIb.glm = glm(RegionVIIb ~ Migraine + Sex + Age + BMI + AssessmentCentre + Alcohol 
                     + Smoking + DiastolicBP + IMD + EthnicBackground + TotalVolume + ViralBacterialNSInfections 
                     + Diabetes + NSDiseases + MentalBehaviouralDisordersPsychoactiveSubstances
                     + PsychiatricMentalBehaviouralDisorders + DevelopmentalDisorders 
                     + EpilepsySleepDisorders + MuscleDisorders + OtherHeadaches 
...
summary(RegionVIIb.glm)$coefficients
...
confint(RegionVIIb.glm)

# Region VIIIa

RegionVIIIa.glm = glm(RegionVIIIa ~ Migraine + Sex + Age + BMI + AssessmentCentre + Alcohol 
                     + Smoking + DiastolicBP + IMD + EthnicBackground + TotalVolume + ViralBacterialNSInfections 
                     + Diabetes + NSDiseases + MentalBehaviouralDisordersPsychoactiveSubstances
                     + PsychiatricMentalBehaviouralDisorders + DevelopmentalDisorders 
                     + EpilepsySleepDisorders + MuscleDisorders + OtherHeadaches 
...
summary(RegionVIIIa.glm)$coefficients
...
confint(RegionVIIIa.glm)

# Region VIIIb

RegionVIIIb.glm = glm(RegionVIIIb ~ Migraine + Sex + Age + BMI + AssessmentCentre + Alcohol 
                     + Smoking + DiastolicBP + IMD + EthnicBackground + TotalVolume + ViralBacterialNSInfections 
                     + Diabetes + NSDiseases + MentalBehaviouralDisordersPsychoactiveSubstances
                     + PsychiatricMentalBehaviouralDisorders + DevelopmentalDisorders 
                     + EpilepsySleepDisorders + MuscleDisorders + OtherHeadaches 
...
summary(RegionVIIIb.glm)$coefficients
...
confint(RegionVIIIb.glm)

# Region IX

RegionIX.glm = glm(RegionIX ~ Migraine + Sex + Age + BMI + AssessmentCentre + Alcohol 
                     + Smoking + DiastolicBP + IMD + EthnicBackground + TotalVolume + ViralBacterialNSInfections 
                     + Diabetes + NSDiseases + MentalBehaviouralDisordersPsychoactiveSubstances
                     + PsychiatricMentalBehaviouralDisorders + DevelopmentalDisorders 
                     + EpilepsySleepDisorders + MuscleDisorders + OtherHeadaches 
...
summary(RegionIX.glm)$coefficients
...
confint(RegionIX.glm)

# Region X

RegionX.glm = glm(RegionX ~ Migraine + Sex + Age + BMI + AssessmentCentre + Alcohol 
                     + Smoking + DiastolicBP + IMD + EthnicBackground + TotalVolume + ViralBacterialNSInfections 
                     + Diabetes + NSDiseases + MentalBehaviouralDisordersPsychoactiveSubstances
                     + PsychiatricMentalBehaviouralDisorders + DevelopmentalDisorders 
                     + EpilepsySleepDisorders + MuscleDisorders + OtherHeadaches 
...
summary(RegionX.glm)$coefficients
...
Cerebellum_Multivariate = cbind(RegionI_IV, RegionV, RegionVI, RegionVIIb, RegionVIIIa, RegionVIIIb, RegionIX, RegionX, CrusI, CrusII)

Cerebellum_Multivariate.lm = lm(Cerebellum_Multivariate ~ Migraine + Sex + Age + BMI + AssessmentCentre + Alcohol 
                             + Smoking + DiastolicBP + IMD + EthnicBackground + TotalVolume + ViralBacterialNSInfections 
                             + Diabetes + NSDiseases + MentalBehaviouralDisordersPsychoactiveSubstances
                             + PsychiatricMentalBehaviouralDisorders + DevelopmentalDisorders 
                             + EpilepsySleepDisorders + MuscleDisorders + OtherHeadaches 
                             + Neuropathies + BrainSpineMalformationsAbnormalities 
                             + CerebrovascularDiseases + HeadSpineInjuriesFractures +
                               CardiovascularDiseases + BrainCancer, data = Dataset)

summary(Cerebellum_Multivariate.lm$coefficients)

Covariance_Matrix = vcov(Cerebellum_Multivariate.lm)

Correlation_Matrix = cov2cor(Covariance_Matrix)

Column1 = Correlation_Matrix[c("RegionI_IV:Migraine1", "RegionV:Migraine1", "RegionVI:Migraine1",
                               "RegionVIIb:Migraine1", "RegionVIIIa:Migraine1", "RegionVIIIb:Migraine1",
                               "RegionIX:Migraine1", "RegionX:Migraine1", "CrusI:Migraine1", "CrusII:Migraine1"), "RegionI_IV:Migraine1"]
Column2 = Correlation_Matrix[c("RegionI_IV:Migraine1", "RegionV:Migraine1", "RegionVI:Migraine1",
                               "RegionVIIb:Migraine1", "RegionVIIIa:Migraine1", "RegionVIIIb:Migraine1",
                               "RegionIX:Migraine1", "RegionX:Migraine1", "CrusI:Migraine1", "CrusII:Migraine1"), "RegionV:Migraine1"]
Column3 = Correlation_Matrix[c("RegionI_IV:Migraine1", "RegionV:Migraine1", "RegionVI:Migraine1",
                               "RegionVIIb:Migraine1", "RegionVIIIa:Migraine1", "RegionVIIIb:Migraine1",
                               "RegionIX:Migraine1", "RegionX:Migraine1", "CrusI:Migraine1", "CrusII:Migraine1"), "RegionVI:Migraine1"]
Column4 = Correlation_Matrix[c("RegionI_IV:Migraine1", "RegionV:Migraine1", "RegionVI:Migraine1",
                               "RegionVIIb:Migraine1", "RegionVIIIa:Migraine1", "RegionVIIIb:Migraine1",
                               "RegionIX:Migraine1", "RegionX:Migraine1", "CrusI:Migraine1", "CrusII:Migraine1"), "RegionVIIb:Migraine1"]
Column5 = Correlation_Matrix[c("RegionI_IV:Migraine1", "RegionV:Migraine1", "RegionVI:Migraine1",
                               "RegionVIIb:Migraine1", "RegionVIIIa:Migraine1", "RegionVIIIb:Migraine1",
                               "RegionIX:Migraine1", "RegionX:Migraine1", "CrusI:Migraine1", "CrusII:Migraine1"), "RegionVIIIa:Migraine1"]
Column6 = Correlation_Matrix[c("RegionI_IV:Migraine1", "RegionV:Migraine1", "RegionVI:Migraine1",
                               "RegionVIIb:Migraine1", "RegionVIIIa:Migraine1", "RegionVIIIb:Migraine1",
                               "RegionIX:Migraine1", "RegionX:Migraine1", "CrusI:Migraine1", "CrusII:Migraine1"), "RegionVIIIb:Migraine1"]
Column7 = Correlation_Matrix[c("RegionI_IV:Migraine1", "RegionV:Migraine1", "RegionVI:Migraine1",
                               "RegionVIIb:Migraine1", "RegionVIIIa:Migraine1", "RegionVIIIb:Migraine1",
                               "RegionIX:Migraine1", "RegionX:Migraine1", "CrusI:Migraine1", "CrusII:Migraine1"), "RegionIX:Migraine1"]
Column8 = Correlation_Matrix[c("RegionI_IV:Migraine1", "RegionV:Migraine1", "RegionVI:Migraine1",
                               "RegionVIIb:Migraine1", "RegionVIIIa:Migraine1", "RegionVIIIb:Migraine1",
                               "RegionIX:Migraine1", "RegionX:Migraine1", "CrusI:Migraine1", "CrusII:Migraine1"), "RegionX:Migraine1"]
Column9 = Correlation_Matrix[c("RegionI_IV:Migraine1", "RegionV:Migraine1", "RegionVI:Migraine1",
                               "RegionVIIb:Migraine1", "RegionVIIIa:Migraine1", "RegionVIIIb:Migraine1",
                               "RegionIX:Migraine1", "RegionX:Migraine1", "CrusI:Migraine1", "CrusII:Migraine1"), "CrusI:Migraine1"]
Column10 = Correlation_Matrix[c("RegionI_IV:Migraine1", "RegionV:Migraine1", "RegionVI:Migraine1",
                               "RegionVIIb:Migraine1", "RegionVIIIa:Migraine1", "RegionVIIIb:Migraine1",
                               "RegionIX:Migraine1", "RegionX:Migraine1", "CrusI:Migraine1", "CrusII:Migraine1"), "CrusII:Migraine1"]

Correlation_Matrix_filtered = cbind(Column1, Column2, Column3, Column4, Column5, Column6, Column7, Column8, Column9, Column10)

colnames(Correlation_Matrix_filtered) = c("RegionI_IV:Migraine1", "RegionV:Migraine1", "RegionVI:Migraine1",
                                          "RegionVIIb:Migraine1", "RegionVIIIa:Migraine1", "RegionVIIIb:Migraine1",
                                          "RegionIX:Migraine1", "RegionX:Migraine1", "CrusI:Migraine1", "CrusII:Migraine1")

install.packages('corrplot')
library(corrplot)

corrplot(Correlation_Matrix_filtered, method = 'number')

# Plotting the results

Brain_Regions = c("I-IV cerebellum", "V cerebellum", "VI cerebellum",
                  "Crus I cerebellum", "Crus II cerebellum", "VIIb cerebellum",
                  "VIIIa cerebellum", "VIIIb cerebellum", "IX cerebellum", "X cerebellum")

Means = c(9, 72, 93, 259, 57, 67, 120, 64, 16, 14)

Lower_Bound = c(-38, 13, .81, 9, -131, -42, 0.9, -21, -57, 1)
  
Upper_Bound =  c(57, 132, 266, 510, 245, 175, 238, 149, 89, 27)

Plot_results = data.frame(Brain_Regions, Means, Lower_Bound, Upper_Bound)
...
Forest_plot = ggplot(data=Plot_results,
                     aes(y = Plot_results$Brain_Regions, x =Plot_results$Means, xmin = Plot_results$Lower_Bound, xmax = Plot_results$Upper_Bound))+
  xlab('Mean difference (95% Confidence Interval)')+ ylab("Cerebellar subregions")+
  geom_errorbar(aes(xmin=Plot_results$Lower_Bound, xmax=Plot_results$Upper_Bound),width=0.2,cex=1) +
...
my_seed = "This cannot be disclosed"

Synthetic_List = syn(Dataset, method = "sample", seed = my_seed)

Synthetic_Dataset = Synthetic_Dataset[['syn']]
